...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient from-orange-100 via-white to-green-100 ">
          ...
          <div className="flex justify-between h-16">
            <div className="flex ">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-800">VoteIndia</span>
              </div>
            ...
            <div className="flex items-center">
              <Link to="/dashboard/profile" className="flex items-center text-gray-700 hover:text-[#FF9933] mr-4">
                <User className="w-5 h-5 mr-1" />
                <span>{user?.name}</span>
              </Link>
              <button
                onClick={handleLogout}
                className="cursor-pointer transition-all inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-[#138808] hover:bg-[#FF9933]"
              >
...
function NavLink({ to, children, icon }) {
  return (
    <Link to={to} className="inline-flex items-center px-1 pt-1 text-sm font-medium text-gray-700 hover:text-[#FF9933]">
      {icon}
